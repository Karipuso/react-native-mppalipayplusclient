...
#import <MPPAlipayPlusClientMPM/MPPAlipayPlusClientMPMProtocol.h>
#import <MPPAlipayPlusClientMPM/MPPLaunchParams.h>
#import <MPPAlipayPlusClientMPM/MPPLaunchResult.h>
#import <UIKit/UIKit.h>

NS_ASSUME_NONNULL_BEGIN

@interface MPPAlipayPlusClient (MPM)
@property (nonatomic, strong) id<MPPAlipayPlusClientMPMProtocol> mpmService;
