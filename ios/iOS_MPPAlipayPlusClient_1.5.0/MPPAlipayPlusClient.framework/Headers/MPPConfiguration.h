...
@interface MPPConfiguration : NSObject
@property (nonatomic, copy) NSString *clientId;
@property (nonatomic, copy, nullable) MPPEnv envType;
@property (nonatomic, copy, nullable) NSString *siteName;

//customized Setting for webview;
@property (nonatomic, weak, nullable) UIViewController *rootVC;
@property (nonatomic, assign) BOOL preferToPresent;
@property (nonatomic, copy, nullable) UIBarButtonItem *(^createCustomizedLeftItemBlock)(id closeTarget, SEL closeSel);
@end
